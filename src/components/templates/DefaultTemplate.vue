...
<template>
  <div class="max-w-[800px] mx-auto p-12 bg-white text-black print-area design-orlando">
    ...
    <div v-if="bankAccount" class="pago-section">
      ...
      <div>
        {{ bankAccount.bank }} {{ bankAccount.account_type }} {{ bankAccount.account_number }}
      </div>
    </div>
    ...
    <div class="concepto-section">
      ...
      <div class="concepto-text">
        Mis ingresos son rentas laborales y solicito aplicar la retención fuente art. 383 ET,
        manifiesto que no aplicare costos y deducciones en mi declaración de renta.
      </div>
    </div>
